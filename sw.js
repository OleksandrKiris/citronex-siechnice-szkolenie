...
const CACHE_NAME = CACHE_PREFIX + "20260719-siechnice-master14";
...
const CORE_ASSETS = [
  ...
  "./assets/css/training.css?v=20260719-siechnice-master14",
  "./assets/js/training-data.js?v=20260719-siechnice-master14",
  "./assets/js/training-app.js?v=20260719-siechnice-master14",
  "./assets/logo-citronex.svg",
  "./assets/content/presenter-guide.json?v=20260719-siechnice-master14",
  "./assets/avatar/cartoon/pose-neutral-v4.png?v=20260719-siechnice-master14",
  "./assets/avatar/cartoon/pose-right-v5.png?v=20260719-siechnice-master14",
  "./assets/avatar/cartoon/pose-left-v4.png?v=20260719-siechnice-master14",
  "./assets/avatar/cartoon/pose-warning-v5.png?v=20260719-siechnice-master14",
  "./assets/avatar/cartoon/pose-reader-v5.png?v=20260719-siechnice-master14",
  "./assets/avatar/cartoon/pose-tablet-v5.png?v=20260719-siechnice-master14",
  ...
  "./assets/audio/guide/pl/01-welcome.mp3?v=20260719-siechnice-master14",
  "./assets/audio/guide/en/01-welcome.mp3?v=20260719-siechnice-master14",
  "./assets/audio/guide/ua/01-welcome.mp3?v=20260719-siechnice-master14",
  "./assets/audio/guide/ru/01-welcome.mp3?v=20260719-siechnice-master14",
  "./assets/audio/guide/az/01-welcome.mp3?v=20260719-siechnice-master14",
  "./assets/audio/guide/es/01-welcome.mp3?v=20260719-siechnice-master14",
  "./assets/audio/guide/fil/01-welcome.mp3?v=20260719-siechnice-master14",
  "./assets/audio/guide/id/01-welcome.mp3?v=20260719-siechnice-master14",
  "./assets/audio/guide/ne/01-welcome.mp3?v=20260719-siechnice-master14",
