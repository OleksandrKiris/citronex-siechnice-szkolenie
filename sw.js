...
const CACHE_NAME = CACHE_PREFIX + "2026-07-06-2";
...
const CORE_ASSETS = [
  ...
  "./assets/css/training.css?v=20260706-color-system1",
  "./assets/js/training-data.js?v=20260706-color-system1",
  "./assets/js/training-app.js?v=20260706-color-system1",
