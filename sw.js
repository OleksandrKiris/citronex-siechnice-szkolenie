...
const CACHE_NAME = CACHE_PREFIX + "20260719-siechnice-master32";
...
const CORE_ASSETS = [
  ...
  "./assets/css/training.css?v=20260719-siechnice-master32",
  "./assets/css/presenter-rig.css?v=20260719-siechnice-master32",
  "./assets/css/presenter-clean.css?v=20260719-siechnice-master32",
  "./assets/css/editor.css?v=20260719-siechnice-master32",
  "./assets/js/training-data.js?v=20260719-siechnice-master32",
  "./assets/js/training-app.js?v=20260719-siechnice-master32",
  "./assets/js/editor.js?v=20260719-siechnice-master32",
  "./assets/logo-citronex.svg",
  "./assets/content/presenter-guide.json?v=20260719-siechnice-master32",
  "./assets/avatar/cartoon/head-v1.png?v=20260719-siechnice-master32",
  "./assets/avatar/cartoon/torso-v1.png?v=20260719-siechnice-master32",
  "./assets/avatar/cartoon/arm-left-v2.png?v=20260719-siechnice-master32",
  "./assets/avatar/cartoon/arm-right-v3.png?v=20260719-siechnice-master32",
  "./assets/avatar/presenter-talking-head-poster-v1.jpg?v=20260719-siechnice-master32",
  ...
  "./assets/audio/guide/pl/01-welcome.mp3?v=20260719-siechnice-master32",
  "./assets/audio/guide/en/01-welcome.mp3?v=20260719-siechnice-master32",
  "./assets/audio/guide/ua/01-welcome.mp3?v=20260719-siechnice-master32",
  "./assets/audio/guide/ru/01-welcome.mp3?v=20260719-siechnice-master32",
  "./assets/audio/guide/az/01-welcome.mp3?v=20260719-siechnice-master32",
  "./assets/audio/guide/es/01-welcome.mp3?v=20260719-siechnice-master32",
  "./assets/audio/guide/fil/01-welcome.mp3?v=20260719-siechnice-master32",
  "./assets/audio/guide/id/01-welcome.mp3?v=20260719-siechnice-master32",
  "./assets/audio/guide/ne/01-welcome.mp3?v=20260719-siechnice-master32",
