...
window.TRAINING_DATA.en = {
  ui: {
    appName: 'Citronex Training',
    location: 'Siechnice',
    mobileReady: 'Mobile version',
    heroTitle: 'Choose a language and start the training',
    heroText: 'After finishing, show the confirmation screen to the coordinator.',
    startBtn: 'Start training',
    resetBtn: 'Clear saved data',
    phoneHint: 'It is best to open the link in your phone browser.',
    progressTitle: 'Training progress',
    quizLabel: 'Control test',
    quizTitle: 'Answer the questions',
    finishBtn: 'Finish training',
    doneTitle: 'Training completed',
    nameLabel: 'Full name',
    namePlaceholder: 'Full name',
    dateLabel: 'Date',
    langLabel: 'Language',
    placeLabel: 'Location',
    copyBtn: 'Copy confirmation',
    showCoordinator: 'Show this screen to the coordinator.',
    footerText: 'Citronex Siechnice information and training system',
    answerAll: 'Answer all questions.',
    tryAgain: 'Correct the answers and try again.',
  ...
  sections: [
    ...
    { title: 'Office and greenhouse entrances', items: ['OFFICE — location: https://www.google.com/maps/d/edit?mid=1QD04JMl9d4AepFLIV1Kc-ZycNRglwuA&usp=sharing', 'How to find the office: red brick building, entrance from the corner, 2nd floor, room No. 2.', 'GREENHOUSES — main entrance map: https://www.google.com/maps/d/edit?mid=1VcKjk2pZ1RgER3GV2DrH8u699hZnnts', 'Greenhouse No.1 — Etap 1: https://maps.app.goo.gl/kG99UiAv9FRvb6DG9?g_st=ic', 'Greenhouse No.2 — Etap 2: https://maps.app.goo.gl/kG99UiAv9FRvb6DG9?g_st=ic', 'Greenhouse No.3 — Etap 3: https://maps.google.com?q=51.0173459,17.1570148&entry=gps&shh=CAE&lucs=,94297699,100795625,94231188,94280568,47071704,100809208,94218641,94282134,100799872,94286869&g_st=ic', 'Greenhouse No.4 — Etap 4: https://maps.google.com?q=51.0173459,17.1570148&entry=gps&shh=CAE&lucs=,94297699,100795625,94231188,94280568,47071704,100809208,94218641,94282134,100799872,94286869&g_st=ic', 'Greenhouse No.5 — Etap 5: https://maps.app.goo.gl/ccG5vb6oE26NDsS76?g_st=ic', 'Greenhouse No.6 — Etap 6: https://maps.app.goo.gl/DH8J1Rtea55mXsoTA?g_st=ic'], notice: 'Important: before the first working day, check your stage and the correct entrance.' },
