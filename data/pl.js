...
window.TRAINING_DATA.pl = {
  ...
  quiz: [
    {
      question: 'Co zrobic, jesli spoznisz sie do pracy?',
      options: ['Nic, przyjsc pozniej', 'Od razu poinformowac koordynatora', 'Poprosic kolege, zeby nic nie mowil'],
      correct: 1
    },
    {
      question: 'Czy mozna samodzielnie zmienic etap lub miejsce pracy?',
      options: ['Tak', 'Nie, tylko po zgodzie brygadzisty albo koordynatora', 'Tak, jezeli jest wolne miejsce'],
      correct: 1
    },
    {
      question: 'Komu zglaszac problem z dokumentami, hotelem albo praca?',
      options: ['Koordynatorowi', 'Dowolnej osobie', 'Nie trzeba zglaszac'],
      correct: 0
    },
    {
      question: 'Co zrobic po ukonczeniu szkolenia?',
      options: ['Zamknac telefon', 'Pokazac ekran potwierdzenia koordynatorowi', 'Usunac strone'],
      correct: 1
    }
  ]
};
