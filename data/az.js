...
window.TRAINING_DATA.az = {
  ui: {
    appName: 'Citronex Təlimi',
    location: 'Siechnice',
    mobileReady: 'Mobil versiya',
    heroTitle: 'Dili seçin və təlimə başlayın',
    heroText: 'Bitirdikdən sonra təsdiq ekranını koordinatora göstərin.',
    startBtn: 'Təlimə başla',
    resetBtn: 'Yaddaşı təmizlə',
    phoneHint: 'Linki telefon brauzerində açmaq daha yaxşıdır.',
    progressTitle: 'Təlimin gedişi',
    quizLabel: 'Yoxlama testi',
    quizTitle: 'Suallara cavab verin',
    finishBtn: 'Təlimi bitir',
    doneTitle: 'Təlim tamamlandı',
    nameLabel: 'Ad və soyad',
    namePlaceholder: 'Ad və soyad',
    dateLabel: 'Tarix',
    langLabel: 'Dil',
    placeLabel: 'Lokasiya',
    copyBtn: 'Təsdiqi kopyala',
    showCoordinator: 'Bu ekranı koordinatora göstərin.',
    footerText: 'Citronex Siechnice məlumat və təlim sistemi',
    answerAll: 'Bütün suallara cavab verin.',
    tryAgain: 'Cavabları düzəldin və yenidən cəhd edin.',
    copied: 'Təsdiq kopyalandı.',
    noName: 'məlumat yoxdur',
