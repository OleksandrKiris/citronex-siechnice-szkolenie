...
const visualHintTemplates = {
  ...
  az: { entrance: "Qırmızı “İşçi girişi” nişanını tapın və qapıları qarşınızdakı yerlə müqayisə edin.", route: "Yolu, binanı və girişi müqayisə edin. Yalnız koordinatorun təsdiqlədiyi marşrutla gedin.", reader: "İşarələnmiş nömrəyə və əl skanerindəki (reader) məhz həmin düyməyə baxın.", tablet: "Ekranda qırmızı çərçivə ilə göstərilən elementi tapın.", diagram: "Sxemdə oxu və yerin adını izləyin.", photo: "Şəkildəki nişanı qarşınızdakı yerlə müqayisə edin." },
  es: { entrance: "Busca el letrero rojo de entrada del personal y compara las puertas con el lugar frente a ti.", route: "Compara la carretera, el edificio y la entrada. Usa solo la ruta confirmada por el coordinador.", reader: "Mira el número resaltado y exactamente ese botón del lector (reader).", tablet: "Busca en la pantalla el elemento rodeado en rojo.", diagram: "Sigue la flecha y el nombre del lugar en el esquema.", photo: "Compara el punto visible con el lugar frente a ti." },
  fil: { entrance: "Hanapin ang pulang karatulang pasukan ng staff at ihambing ang mga pinto sa lugar sa harap mo.", route: "Ihambing ang daan, gusali at pasukan. Sundin lamang ang rutang kinumpirma ng coordinator.", reader: "Tingnan ang minarkahang numero at ang mismong button na iyon sa scanner (reader).", tablet: "Hanapin sa screen ang elementong may pulang kahon.", diagram: "Sundan ang arrow at pangalan ng lugar sa diagram.", photo: "Ihambing ang palatandaan sa larawan sa lugar sa harap mo." },
  id: { entrance: "Temukan tanda merah pintu masuk staf dan cocokkan pintunya dengan tempat di depan Anda.", route: "Cocokkan jalan, gedung, dan pintu masuk. Ikuti hanya rute yang dikonfirmasi koordinator.", reader: "Lihat nomor yang disorot dan tombol yang tepat pada pemindai (reader).", tablet: "Temukan elemen yang diberi bingkai merah pada layar.", diagram: "Ikuti panah dan nama tempat pada diagram.", photo: "Cocokkan penanda pada foto dengan tempat di depan Anda." },
  ne: { entrance: "रातो कर्मचारी प्रवेश चिन्ह खोज्नुहोस् र ढोकालाई अगाडिको स्थानसँग मिलाउनुहोस्।", route: "बाटो, भवन र प्रवेशद्वार तुलना गर्नुहोस्। संयोजकले पुष्टि गरेको मार्ग मात्र प्रयोग गर्नुहोस्।", reader: "देखाइएको नम्बर र स्क्यानरको (रिडर) ठीक त्यही बटन हेर्नुहोस्।", tablet: "स्क्रिनमा रातो घेराले देखाएको भाग खोज्नुहोस्।", diagram: "चित्रमा तीर र स्थानको नाम पछ्याउनुहोस्।", photo: "तस्बिरको चिन्हलाई अगाडिको स्थानसँग मिलाउनुहोस्।" }
};
...
function buildGuide(lang) {
  ...
  const add = ({ id, group, title, parts, image = "", icon = "", pose = "right", tone = "neutral", focus = null, quizIndex = null, sourceLabel = "", sourceUrl = "" }) => {
    ...
    const category = group === "start" ? "listen" : group === "help" ? "help" : tone === "danger" ? "forbidden" : tone === "caution" ? "important" : "action";
    sections.push({
      id,
      group,
