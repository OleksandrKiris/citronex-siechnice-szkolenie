(() => {
  ...
  window.CX_DATA = {
    meta: {
      version: "20260720-siechnice-master40",
      ...
      externalInformationSources: [
        ...
        "https://www.gov.pl/web/numer-alarmowy-112/numer-alarmowy-1123",
        "https://zozolawa.wroc.pl/kontakt/szpitalny-oddzial-ratunkowy.html",
        "https://usk.wroc.pl/index.php?Itemid=69&id=383&option=com_content&view=article",
        "https://www.gov.pl/web/dolnoslaski-uw/pobyt-czasowy",
        "https://www.siechnice.gmina.pl/"
      ]
    },
    ...
    pages: {
      ...
      szklarnia: {
        ...
        lead: tx("Szklarnię pokazujemy w trzech prostych krokach: całość, jedna nawa i wejście do rzędu. Nawa to wydzielona część szklarni.", "The greenhouse is shown in three simple steps: the whole greenhouse, one bay called a nave, and the entrance to a row.", "Теплицю показано у трьох простих кроках: уся теплиця, одна нава — тобто секція теплиці — та вхід у ряд.", "Теплица показана в трёх простых шагах: вся теплица, одна нава — то есть секция теплицы — и вход в ряд.", "İstixana üç sadə addımda göstərilir: bütün istixana, nava adlanan bir bölmə və sıraya giriş.", "El invernadero se explica en tres pasos sencillos: todo el invernadero, una nave —es decir, una sección— y la entrada a una fila.", "Ipinapakita ang bahay-taniman sa tatlong simpleng hakbang: buong bahay-taniman, isang nawa —seksyon ng bahay-taniman— at pasukan sa isang hanay.", "Rumah kaca dijelaskan dalam tiga langkah sederhana: seluruh rumah kaca, satu nave —bagian rumah kaca— dan pintu masuk ke baris.", "ग्रीनहाउसलाई तीन सरल चरणमा देखाइएको छ: पूरा ग्रीनहाउस, एउटा नावा अर्थात् ग्रीनहाउसको खण्ड, र पङ्क्तिमा जाने प्रवेशद्वार।")
      },
      reader: {
    ...
    firstDay: {
      ...
      steps: [
        { title: tx("Wybierz miejsce", "Choose the place", "Оберіть місце", "Выберите место", "Yeri seçin", "Elige el lugar", "Piliin ang lugar", "Pilih tempat", "ठाउँ छान्नुहोस्"), note: tx("Wybierz etap szklarni E1-E6, magazyn albo punkt spotkania wskazany w wiadomości startowej.", "Choose the greenhouse section E1-E6, warehouse or meeting point shown in the start message.", "Оберіть сектор теплиці E1-E6, склад або місце зустрічі, вказане у стартовому повідомленні.", "Выберите сектор теплицы E1-E6, склад или место встречи, указанное в стартовом сообщении.", "Başlanğıc mesajında göstərilən E1-E6 istixana bölməsini, anbarı və ya görüş yerini seçin.", "Elige la sección del invernadero E1-E6, el almacén o el punto de encuentro indicado en el mensaje inicial.", "Piliin ang seksyon ng bahay-taniman E1-E6, ang bodega, o ang lugar ng pagkikita na nakasaad sa unang mensahe.", "Pilih bagian rumah kaca E1-E6, gudang, atau titik temu yang tertulis dalam pesan awal.", "सुरुको सन्देशमा दिइएको ग्रीनहाउस खण्ड E1-E6, गोदाम वा भेट्ने ठाउँ छान्नुहोस्।") },
    ...
    medical: [
      {
        ...
        body: [
          ...
          tx("Rejestracja ogólna: poniedziałek-piątek, 8:00-18:00. Przed wizytą zadzwoń i potwierdź termin oraz potrzebne dokumenty.", "General registration: Monday-Friday, 8:00-18:00. Call before visiting to confirm the appointment and required documents.", "Загальна реєстрація: понеділок-п’ятниця, 8:00-18:00. Перед візитом зателефонуйте, щоб підтвердити час і потрібні документи.", "Общая регистратура: понедельник-пятница, 8:00-18:00. Перед визитом позвоните и уточните время и необходимые документы.", "Ümumi qeydiyyat: bazar ertəsi-cümə, 8:00-18:00. Getməzdən əvvəl zəng edib vaxtı və lazım olan sənədləri təsdiqləyin.", "Registro general: lunes-viernes, 8:00-18:00. Llama antes de ir para confirmar la cita y los documentos necesarios.", "Pangkalahatang registration: Lunes-Biyernes, 8:00-18:00. Tumawag bago pumunta para kumpirmahin ang oras at kailangang dokumento.", "Pendaftaran umum: Senin-Jumat, 8:00-18:00. Telepon sebelum datang untuk memastikan jadwal dan dokumen yang diperlukan.", "सामान्य दर्ता: सोमबार-शुक्रबार, 8:00-18:00। जानुअघि फोन गरेर समय र चाहिने कागजात पुष्टि गर्नुहोस्।"),
          tx("Weź dokument tożsamości, PESEL, jeśli go masz, oraz telefon. Rejestracja wskaże, co jeszcze jest potrzebne.", "Take an identity document, your PESEL if you have one, and a phone. Registration will tell you what else is required.", "Візьміть документ, що посвідчує особу, PESEL, якщо маєте, і телефон. У реєстратурі скажуть, що ще потрібно.", "Возьмите документ, удостоверяющий личность, PESEL, если он у вас есть, и телефон. В регистратуре скажут, что ещё необходимо.", "Şəxsiyyət sənədini, varsa PESEL-i və telefonu götürün. Qeydiyyat sizə başqa nə lazım olduğunu deyəcək.", "Lleva un documento de identidad, PESEL si lo tienes y el teléfono. En registro te dirán qué más necesitas.", "Dalhin ang ID, PESEL kung mayroon, at telepono. Sasabihin ng registration kung ano pa ang kailangan.", "Bawa dokumen identitas, PESEL jika ada, dan telepon. Bagian pendaftaran akan memberi tahu apa lagi yang diperlukan.", "पहिचान कागजात, भएमा PESEL, र फोन लैजानुहोस्। दर्ता कक्षले अरू के चाहिन्छ बताउनेछ।")
        ],
        map: gozMap,
        sourceLabel: tx("Oficjalna informacja Gminy Siechnice", "Official information from Siechnice Municipality", "Офіційна інформація гміни Siechnice", "Официальная информация гмины Siechnice", "Siechnice bələdiyyəsinin rəsmi məlumatı", "Información oficial del municipio de Siechnice", "Opisyal na impormasyon ng Siechnice Municipality", "Informasi resmi Pemerintah Siechnice", "Siechnice नगरपालिकाको आधिकारिक जानकारी"),
        sourceUrl: "https://www.siechnice.gmina.pl/strona-78-ochrona_zdrowia.html",
        phones: [
      ...
      },
      {
        ...
        body: [
          tx("SOR jest dla nagłego zagrożenia życia lub zdrowia, na przykład: utrata przytomności, poważne problemy z oddychaniem, silne krwawienie, podejrzenie zawału lub udaru, ciężki uraz albo nagłe poważne pogorszenie stanu.", "An emergency department is for a sudden threat to life or health, for example loss of consciousness, serious breathing difficulty, heavy bleeding, suspected heart attack or stroke, severe injury, or sudden serious deterioration.", "SOR призначений для раптової загрози життю або здоров’ю, наприклад: втрата свідомості, серйозні проблеми з диханням, сильна кровотеча, підозра на інфаркт чи інсульт, тяжка травма або раптове значне погіршення стану.", "SOR предназначен для внезапной угрозы жизни или здоровью, например: потеря сознания, серьёзные проблемы с дыханием, сильное кровотечение, подозрение на инфаркт или инсульт, тяжёлая травма либо внезапное серьёзное ухудшение состояния.", "Təcili yardım şöbəsi həyat və ya sağlamlıq üçün qəfil təhlükə halları üçündür: huşun itməsi, ciddi nəfəs darlığı, güclü qanaxma, infarkt və ya insult şübhəsi, ağır zədə və ya vəziyyətin qəfil ciddi pisləşməsi.", "Urgencias es para una amenaza repentina para la vida o la salud, por ejemplo pérdida de conciencia, dificultad grave para respirar, hemorragia intensa, sospecha de infarto o ictus, lesión grave o empeoramiento repentino importante.", "Ang emergency department ay para sa biglaang panganib sa buhay o kalusugan, gaya ng pagkawala ng malay, malubhang hirap huminga, matinding pagdurugo, hinalang atake sa puso o stroke, malubhang pinsala, o biglaang malubhang paglala.", "IGD adalah untuk ancaman mendadak terhadap nyawa atau kesehatan, misalnya kehilangan kesadaran, sesak napas berat, perdarahan hebat, dugaan serangan jantung atau stroke, cedera berat, atau kondisi yang tiba-tiba memburuk serius.", "आपतकालीन विभाग जीवन वा स्वास्थ्यमा अचानक गम्भीर खतरा हुँदा हो, जस्तै बेहोस हुनु, गम्भीर सास समस्या, धेरै रगत बग्नु, हृदयाघात वा स्ट्रोकको शंका, गम्भीर चोट वा अवस्था अचानक धेरै बिग्रनु।"),
          tx("Jeśli sytuacja wymaga natychmiastowej pomocy służb, dzwoń 112. Przy problemie niebędącym nagłym zagrożeniem skontaktuj się z przychodnią albo zadzwoń do NFZ 800 190 590.", "If emergency services are needed immediately, call 112. For a problem that is not an immediate threat, contact a clinic or call the NFZ helpline on 800 190 590.", "Якщо потрібна негайна допомога служб, телефонуйте 112. Якщо немає безпосередньої загрози, зверніться до поліклініки або зателефонуйте до NFZ 800 190 590.", "Если экстренная помощь нужна немедленно, звоните 112. Если непосредственной угрозы нет, обратитесь в поликлинику или позвоните в NFZ 800 190 590.", "Təcili xidmətlərin dərhal köməyi lazımdırsa, 112-yə zəng edin. Dərhal təhlükə yoxdursa, poliklinika ilə əlaqə saxlayın və ya NFZ 800 190 590 nömrəsinə zəng edin.", "Si necesitas ayuda inmediata de emergencias, llama al 112. Si no existe una amenaza inmediata, contacta con una clínica o llama al NFZ 800 190 590.", "Kung kailangan agad ang emergency services, tumawag sa 112. Kung hindi agarang panganib, kontakin ang klinika o tumawag sa NFZ 800 190 590.", "Jika layanan darurat dibutuhkan segera, hubungi 112. Jika bukan ancaman langsung, hubungi klinik atau layanan NFZ 800 190 590.", "तत्काल आपतकालीन सेवा चाहिन्छ भने 112 मा फोन गर्नुहोस्। तत्काल खतरा नभए क्लिनिकमा सम्पर्क गर्नुहोस् वा NFZ 800 190 590 मा फोन गर्नुहोस्।")
        ],
        sourceLabel: tx("Zasady 112 i oficjalne informacje SOR", "Official 112 and emergency-department information", "Офіційні правила 112 та інформація SOR", "Официальные правила 112 и информация SOR", "112 və təcili yardım barədə rəsmi məlumat", "Información oficial sobre 112 y urgencias", "Opisyal na impormasyon tungkol sa 112 at emergency", "Informasi resmi 112 dan IGD", "112 र आपतकालीन विभागको आधिकारिक जानकारी"),
        sourceUrl: "https://www.gov.pl/web/numer-alarmowy-112/kiedy-dzwonic-i-nie-dzwonic-na-numer-alarmowy-112",
        maps: [
          { label: "SOR Oława — K.K. Baczyńskiego 1", address: "ul. K.K. Baczyńskiego 1, 55-200 Oława", url: "https://maps.app.goo.gl/9oCDLCRmdZHyJ6wi8", sourceUrl: "https://zozolawa.wroc.pl/kontakt/szpitalny-oddzial-ratunkowy.html" },
          { label: "SOR Wrocław — Borowska 213", address: "ul. Borowska 213, 50-556 Wrocław", url: "https://maps.app.goo.gl/PTFDRQC7fnsVRqhY8", sourceUrl: "https://usk.wroc.pl/index.php?Itemid=69&id=383&option=com_content&view=article" }
        ]
      },
      {
        tone: "yellow",
        ...
        body: [
          ...
          tx("Konsultant NFZ może wskazać aktualną pomoc stomatologiczną, najbliższy SOR oraz nocną i świąteczną opiekę. Infolinia działa bezpłatnie 24 godziny na dobę, 7 dni w tygodniu.", "The NFZ consultant can identify current dental care, the nearest emergency department, and night or holiday care. The helpline is free and operates 24 hours a day, 7 days a week.", "Консультант NFZ може вказати актуальну стоматологічну допомогу, найближчий SOR і нічну та святкову допомогу. Лінія безплатна й працює цілодобово, 7 днів на тиждень.", "Консультант NFZ подскажет актуальную стоматологическую помощь, ближайший SOR и ночную или праздничную помощь. Линия бесплатная и работает круглосуточно, 7 дней в неделю.", "NFZ məsləhətçisi cari stomatoloji yardımı, ən yaxın təcili şöbəni və gecə-bayram yardımını göstərə bilər. Xətt pulsuzdur və həftənin 7 günü, 24 saat işləyir.", "El asesor de NFZ puede indicar la atención dental actual, el SOR más cercano y la atención nocturna o festiva. La línea es gratuita y funciona las 24 horas, los 7 días.", "Maaaring ituro ng NFZ consultant ang kasalukuyang dental care, pinakamalapit na emergency department, at night o holiday care. Libre ang linya at bukas 24 oras, 7 araw sa isang linggo.", "Konsultan NFZ dapat menunjukkan layanan gigi terbaru, IGD terdekat, serta layanan malam atau hari libur. Layanan ini gratis dan aktif 24 jam sehari, 7 hari seminggu.", "NFZ सल्लाहकारले हालको दन्त सेवा, नजिकको आपतकालीन विभाग र राति वा बिदाको सेवा बताउन सक्छ। फोन सेवा निःशुल्क र हप्ताको 7 दिन, 24 घण्टा खुला हुन्छ।"),
          tx("Gdy obrzęk twarzy utrudnia oddychanie lub połykanie albo stan szybko się pogarsza, dzwoń 112.", "If facial swelling makes breathing or swallowing difficult, or the condition is rapidly worsening, call 112.", "Якщо набряк обличчя ускладнює дихання чи ковтання або стан швидко погіршується, телефонуйте 112.", "Если отёк лица затрудняет дыхание или глотание либо состояние быстро ухудшается, звоните 112.", "Üz şişməsi nəfəs almağı və ya udmağı çətinləşdirirsə, yaxud vəziyyət sürətlə pisləşirsə, 112-yə zəng edin.", "Si la hinchazón de la cara dificulta respirar o tragar, o el estado empeora rápidamente, llama al 112.", "Kung nahihirapang huminga o lumunok dahil sa pamamaga ng mukha, o mabilis lumalala ang kondisyon, tumawag sa 112.", "Jika pembengkakan wajah membuat sulit bernapas atau menelan, atau kondisi memburuk cepat, hubungi 112.", "अनुहार सुन्निँदा सास फेर्न वा निल्न गाह्रो हुन्छ वा अवस्था छिटो बिग्रन्छ भने 112 मा फोन गर्नुहोस्।")
        ],
        sourceLabel: tx("Telefoniczna Informacja Pacjenta NFZ", "NFZ Patient Information Helpline", "Телефонна інформація пацієнта NFZ", "Телефонная информация пациента NFZ", "NFZ Xəstə Məlumat Xətti", "Información Telefónica del Paciente NFZ", "NFZ Patient Information Helpline", "Layanan Informasi Pasien NFZ", "NFZ बिरामी सूचना फोन सेवा"),
        sourceUrl: "https://www.nfz.gov.pl/kontakt/telefoniczna-informacja-pacjenta/",
        phones: [
          { label: tx("NFZ - aktualna pomoc medyczna", "NFZ - current medical care", "NFZ - актуальна медична допомога", "NFZ - актуальная медицинская помощь", "NFZ - cari tibbi yardım", "NFZ - atención médica actual", "NFZ - kasalukuyang medical care", "NFZ - layanan medis terkini", "NFZ - हालको स्वास्थ्य सेवा"), phone: "800190590" }
        ]
      }
    ],
    ...
    city: [
      {
        tone: "blue",
        icon: "document",
        tag: tx("Karta pobytu", "Residence card", "Карта побиту", "Карта побыту", "Yaşayış kartı", "Tarjeta de residencia", "Card ng paninirahan", "Kartu tinggal", "बसोबास अनुमति कार्ड"),
        title: tx("DUW - karta pobytu", "DUW - residence card", "DUW - карта побиту", "DUW - карта побыту", "DUW - yaşayış kartı", "DUW - tarjeta de residencia", "DUW - card ng paninirahan", "DUW - kartu tinggal", "DUW - बसोबास अनुमति कार्ड"),
        address: "pl. Powstańców Warszawy 1, 50-153 Wrocław",
        note: tx("Sprawy legalizacji pobytu prowadzi Dolnośląski Urząd Wojewódzki. Sposób złożenia dokumentów i odbioru karty zależy od rodzaju sprawy — przed wizytą sprawdź aktualną instrukcję.", "Residence legalisation matters are handled by the Lower Silesian Voivodeship Office. How documents are submitted and a card is collected depends on the case, so check the current instructions before visiting.", "Справи легалізації перебування веде Нижньосілезьке воєводське управління. Спосіб подання документів і отримання картки залежить від справи — перед візитом перевірте актуальну інструкцію.", "Вопросами легализации пребывания занимается Нижнесилезское воеводское управление. Способ подачи документов и получения карты зависит от дела — перед визитом проверьте актуальную инструкцию.", "Yaşayışın leqallaşdırılması işlərini Aşağı Sileziya Voyevodalıq İdarəsi aparır. Sənədlərin təqdim edilməsi və kartın alınması işin növündən asılıdır — getməzdən əvvəl cari təlimatı yoxlayın.", "Los trámites de legalización de estancia los gestiona la Oficina del Voivodato de Baja Silesia. La forma de presentar documentos y recoger la tarjeta depende del caso; consulta la instrucción actual antes de ir.", "Ang Lower Silesian Voivodeship Office ang humahawak ng residence legalisation. Depende sa uri ng kaso ang pagsusumite ng dokumento at pagkuha ng card, kaya tingnan muna ang kasalukuyang tagubilin.", "Urusan legalisasi tinggal ditangani Kantor Provinsi Silesia Hilir. Cara menyerahkan dokumen dan mengambil kartu bergantung pada jenis perkara; cek petunjuk terbaru sebelum datang.", "बसोबास वैधानिकीकरणसम्बन्धी काम Lower Silesian Voivodeship Office ले गर्छ। कागजात बुझाउने र कार्ड लिने तरिका मुद्दाअनुसार फरक हुन्छ, त्यसैले जानुअघि हालको निर्देशन जाँच गर्नुहोस्।"),
        list: [
        ...
        links: [
          ...
          { url: "https://www.gov.pl/web/dolnoslaski-uw/pobyt-czasowy", label: tx("Sprawdź aktualną procedurę", "Check the current procedure", "Перевірити актуальну процедуру", "Проверить актуальную процедуру", "Cari proseduru yoxla", "Consultar el procedimiento actual", "Tingnan ang kasalukuyang procedure", "Cek prosedur terbaru", "हालको प्रक्रिया जाँच्नुहोस्"), tone: "blue" }
        ]
      },
      {
        tone: "blue",
